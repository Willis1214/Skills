...
| PM Consultant | [`PM-Consultant-Skill`](https://github.com/Willis1214/Skills/tree/PM-Consultant-Skill) | `1.2.0` | `v1.2.0`, 2026-06-03: added a Red Team review and remediation gate before final PRD/story-map/QC outputs; `High` findings now block final artifacts until remediated and confirmed. | Clarifies requirements, user story maps, input/output contracts, boundaries, QC checklists, and Red Team risks before implementation without prescribing the implementation path. | You need a confirmed PRD Markdown, user-story-map HTML, and QC checklist Markdown package, with adversarial high-risk review cleared, before starting implementation. |
