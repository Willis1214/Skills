...
| Brainstorm | [`Brainstorm-Skill`](https://github.com/Willis1214/Skills/tree/Brainstorm-Skill) | `2.0.0` | `v2.0.0`, 2026-06-11: renamed PM Consultant / `pm-consultant` to Brainstorm / `brainstorm`, preserved the six-step PRD-first workflow, and added local-skill-first Red Team and Front Taste module routing. | Clarifies requirements, user story maps, input/output contracts, boundaries, QC checklists, Red Team risks, and Front Taste findings before implementation without prescribing the implementation path. | You need a confirmed PRD Markdown, user-story-map HTML, and QC checklist Markdown package, with local Red Team and visual/taste review evidence handled before starting implementation. |
