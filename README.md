...
3. 再判断是否构成交付问题: expected behavior, actual behavior, and material impact.
4. 再审合同和证据: PRD, SOP, API contract, handoff agreement, release checklist, waiver, and proof strength.
5. 最后做归因和沟通: attribution matrix, Owner / RACI, 结论把握度, and Chinese communication boundaries.
