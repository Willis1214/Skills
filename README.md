...
| Brainstorm | [`Brainstorm-Skill`](https://github.com/Willis1214/Skills/tree/Brainstorm-Skill) | `2.1.0` | `v2.1.0`, 2026-07-01: changed Brainstorm from serial step discussion into a repeatable round loop with fixed role-based coverage across requirements, story/flow, confirmation, QC thinking, and risk attack. | Clarifies ambiguous engineering or product ideas through repeatable role-based discussion rounds, then produces PRD Markdown, user-story-map HTML, and QC checklist Markdown after Red Team and optional Front Taste gates. | You need a confirmed requirement package before implementation and want every discussion round to cover requirement clarification, story/flow mapping, structured confirmation, QC thinking, and risk attack without prescribing the implementation path. |
